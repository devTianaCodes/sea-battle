  ...
  return (
    <div className="glass-light rounded-[1.5rem] p-4">
      <div className="mb-3 flex items-center justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.24em] text-cyan/70">Ships</p>
          <h2 className="text-sm uppercase tracking-[0.18em] text-slate-300">Deployment</h2>
        </div>
        ...
        {SHIP_DEFINITIONS.map((ship) => {
          ...
          return (
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className={clsx(
                "flex min-w-[132px] flex-1 items-center justify-between rounded-[1.05rem] border px-3 py-2.5 text-left transition duration-200 md:min-w-0",
                isSelected
              ...
              <div>
                ...
                <div className="text-[0.62rem] uppercase tracking-[0.1em] text-slate-500">
